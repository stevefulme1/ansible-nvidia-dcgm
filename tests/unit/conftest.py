"""Shared pytest fixtures for nvidia_dcgm collection unit tests."""
...
try:
    import ansible_collections.stevefulme1.nvidia_dcgm  # noqa: F401
    ...
    _coll_mod = types.ModuleType("ansible_collections.stevefulme1.nvidia_dcgm")
    _coll_mod.__path__ = [_collection_root]
    _coll_mod.__package__ = "ansible_collections.stevefulme1.nvidia_dcgm"
    sys.modules["ansible_collections.stevefulme1.nvidia_dcgm"] = _coll_mod
