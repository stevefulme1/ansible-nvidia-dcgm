"""Common argument specs and constants for NVIDIA DCGM GPU management."""
...
short_description: Shared argument specs and constants for NVIDIA DCGM GPU management
description:
...
NVIDIA_COMMON_ARGS = dict(
    api_url=dict(type="str", default="http://localhost:5555"),
