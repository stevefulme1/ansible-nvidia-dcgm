...
"""Ansible module for run dcgm gpu health checks."""
...
DOCUMENTATION = r"""
---
module: dcgm_health_check
short_description: Run DCGM GPU health checks
description:
    - Run DCGM GPU health checks using the NVIDIA REST API.
...
options:
    group_id:
        description:
            - The group id for the health check.
        type: str
    state:
        description:
...
- name: Create a health check
  stevefulme1.nvidia_dcgm.dcgm_health_check:
